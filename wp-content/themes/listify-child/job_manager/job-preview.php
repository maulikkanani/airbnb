<form method="post" id="job_preview" action="<?php echo esc_url( $form->get_action() ); ?>">
    ...
    <div class="job_listing_preview single_job_listing">
        ...
        <input type="hidden" name="_wc_booking_enable_range_picker" value="<?php if(isset($_POST['_wc_booking_enable_range_picker'])){ echo $_POST['_wc_booking_enable_range_picker']; }else{ echo 'no'; } ?>" />
        <input type="hidden" name="_wc_booking_requires_confirmation" value="<?php if(isset($_POST['_wc_booking_requires_confirmation'])){ echo $_POST['_wc_booking_requires_confirmation']; }else{ echo 'no'; } ?>" />
        <input type="hidden" name="_wc_booking_user_can_cancel" value="<?php if(isset($_POST['_wc_booking_user_can_cancel'])){ echo $_POST['_wc_booking_user_can_cancel']; }else{ echo 'no'; } ?>" />
...
<!--  End Availability to get value on preview page -->   
    ...
    <!--persons-->
        ...
        <input type="hidden" name="_wc_booking_person_cost_multiplier" value="<?php if(isset($_POST['_wc_booking_person_cost_multiplier'])){ echo $_POST['_wc_booking_person_cost_multiplier']; }else{ echo 'no'; } ?>" />
        <input type="hidden" name="_wc_booking_person_qty_multiplier" value="<?php if(isset($_POST['_wc_booking_person_qty_multiplier'])){ echo $_POST['_wc_booking_person_qty_multiplier']; }else{ echo 'no'; } ?>" />
        <input type="hidden" name="_wc_booking_has_person_types" value="<?php if(isset($_POST['_wc_booking_has_person_types'])){ echo $_POST['_wc_booking_has_person_types']; }else{ echo 'no'; } ?>" />
        <input type="hidden" name="has_person" value="<?php if(isset($_POST['has_person'])){ echo $_POST['has_person'];}else{ echo 'no';} ?>">
        <input type="hidden" name="has_resource" value="<?php if(isset($_POST['has_resource'])){ echo $_POST['has_resource'];}else{ echo 'no';} ?>">
        <?php 
