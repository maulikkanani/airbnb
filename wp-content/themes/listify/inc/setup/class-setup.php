...
class Listify_Setup {
	...
	public static function init() {
		...
		add_action( 'init', array( __CLASS__, 'setup_guide' ), 11 );
	}

	public static function includes() {
		include_once( dirname( __FILE__ ) . '/lib/astoundify-setupguide/class-astoundify-setup-guide.php' );
...
/** Place any new code below this line */";
	...
	public static function setup_guide() {
		...
		Astoundify_Setup_Guide::init( array(
			...
			'stylesheet_uri' => get_template_directory_uri() . '/inc/setup/lib/astoundify-setupguide/assets/css/style.css',
		) );
	}
	...
	public static function get_recommended_plugins() {
		return array(
			...
			'wp-job-manager-products' => array(
				'label' => '<a href="https://astoundify.com/downloads/wp-job-manager-products/" target="_blank">WP Job Manager - Products</a>',
				'condition' => class_exists( 'WP_Job_Manager_Products' ),
				'pack' => array( 'rentals' )
			),
			'wp-job-manager-reviews' => array(
				'label' => '<a href="https://astoundify.com/downloads/wp-job-manager-reviews/" target="_blank">WP Job Manager - Reviews</a>',
				'condition' => 'WP_Job_Manager_Reviews',
				'pack' => array( 'rentals' )
			),
			...
			'woocommerce-bookings' => array(
				'label' => '<a href="http://astoundify.com/go/woocommerce-bookings" target="_blank">WooCommerce Bookings</a>',
