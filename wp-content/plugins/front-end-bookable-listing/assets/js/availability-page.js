...
/* 09-10-2017 */
    ...
    jQuery('#_wc_booking_user_can_cancel').change(function () {
        if (jQuery(this).is(':checked')) {
            ...
            jQuery('#_wc_booking_user_can_cancel').val('no');
    ...
    jQuery('#_wc_booking_requires_confirmation').change(function () {
        if (jQuery(this).is(':checked')) {
            ...
            jQuery('#_wc_booking_requires_confirmation').val('no');
        }
    ...
    jQuery('#_wc_booking_enable_range_picker').change(function () {
        if (jQuery(this).is(':checked')) {
            ...
            jQuery('#_wc_booking_enable_range_picker').val('no');
...
//    }); 
    ...
    jQuery('#_wc_booking_person_cost_multiplier').change(function () {
        if (jQuery(this).is(':checked')) {
            ...
            jQuery('#_wc_booking_person_cost_multiplier').val('no');
        }
    });
    ...
    jQuery('#_wc_booking_person_qty_multiplier').change(function () {
        if (jQuery(this).is(':checked')) {
            ...
            jQuery('#_wc_booking_person_qty_multiplier').val('no');
        }
    });
    ...
    jQuery('#_wc_booking_has_person_types').change(function () {
        if (jQuery(this).is(':checked')) {
            ...
            jQuery('#_wc_booking_has_person_types').val('no');
        }
    ...
    jQuery('#_wc_booking_has_persons').change(function () {
        if (jQuery(this).is(':checked')) {
            jQuery('#_wc_booking_has_persons').val('yes');
        }else{
            jQuery('#_wc_booking_has_persons').val('no');
        }
