		...
		<tbody>
			<tr>
				<td>
					...
					<input type="text" class="person_name" name="person_name[<?php // echo $loop; ?>]" value="<?php // echo esc_attr( $person_type->post_title ); ?>" placeholder="<?php _e( 'Name', 'woocommerce-bookings' ); ?>" />
				</td>
				<td>
					...
					<?php do_action( 'woocommerce_bookings_after_person_cost'); ?>
				</td>
				<td>
					...
					<?php do_action( 'woocommerce_bookings_after_person_block_cost' ); ?>
				</td>
				<?php do_action( 'woocommerce_bookings_after_person_block_cost_column' ); ?>
			</tr>
			<tr>
				<td>
				...
				<?php do_action( 'woocommerce_bookings_after_person_max_column'); ?>
			</tr>
		</tbody>
	</table>
</div>